...
export const projects = [
    ...
    },
    {
        ...
        description: 'This game outputs a face using ASCII characters. Follow the prompts on the screen to choose the type of hair, nose, eyes, and smile you would like. Hit enter after each one.', //project description
    ...
    {
        name: 'Palindrome',
        description: 'Program that uses recursion to check if a word is a palindrome. Type in a word into the console and it will return if the word is or is not a palindrome.',
